...
import { generateBillPile, generateAmountChoices } from './moneyData.js'
...
function newProblem() {
  ...
  return { pieces, total, choices: generateAmountChoices(total, 3, 200) }
}

export default function CountBills({ onBack }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-neyou-cream via-white to-white p-4 sm:p-6 space-y-6">
      ...
      <NextProblemButton onClick={next}>New Bills</NextProblemButton>
    </div>
  )
}
